...
<template>
  ...
  <div
    class="flex justify-start items-center bg-amber-100 py-4 xl:py-10 ps-20 xl:ps-64"
  >
    <i class="bi bi-instagram text-3xl xl:text-6xl me-4"></i>
    <p class="text-2xl xl:text-4xl font-sans">varadifi</p>
  </div>
  <!-- Instagram feed -->
</template>
